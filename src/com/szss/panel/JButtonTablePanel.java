...
import com.szss.archives.UpdateDepotFrame;
import com.szss.archives.UpdateStockFrame;
import com.szss.bean.Stock;
import com.szss.dao.StockDao;
import com.szss.jbutton.ButtonEditor;
import com.szss.jbutton.ButtonRenderer;
...
public class JButtonTablePanel extends JPanel {
	...
	public JButtonTablePanel() {
		...
		dm.setDataVector(new Object[][]{{"","","","","","","",""}},
	                     new Object[]{"是否入库","编号","客户","订单号","订货日期","商品名","金额","数量"});	                     
		dm.removeRow(0);
		table = new JTable(dm);
